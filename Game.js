...
class Game {
    ...
    constructor () {
        ...
        this.score  = 0; // Puntuación obtenida por el usuario
    }
     ...
     */
    removeOpponent () {                               
        /*if ( (this.opponent) && (this.opponent.constructor.name === 'Opponent') ) {
            document.body.removeChild(this.opponent.image);            
            //this.opponent = new Opponent(this);
            this.opponent = new Boss(this);
        }*/ 
        /*else if ( (this.opponent) && (this.opponent.constructor.name === 'Boss') ) {       
            this.endGame();    
        }*/
        document.body.removeChild(this.opponent.image);            
        this.opponent = new Opponent(this);
    ...
    endGame () {
        ...
        if ( this.player.lives > 0 ) {
            let gameOver = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, GAME_OVER_YOU_WIN_PICTURE)
        }
        else {
